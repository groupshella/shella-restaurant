	...
	return (
		<div className="min-h-screen bg-gray-50 " dir="rtl">
			<div className="mx-auto max-w-[1800px] px-4 py-8 sm:px-6 lg:px-8">
				...
				<section className="mb-8 rounded-lg bg-white  p-6 md:p-12">
					{/* Section Title */}
					...
					{/* Benefits Grid */}
					<div className="container mx-auto border-2 border-gray-200  px-4 md:px-12 py-8">
				...
				<section className="mb-8 rounded-xl bg-white  p-6 shadow-md md:p-12">
					{/* Form Title */}
